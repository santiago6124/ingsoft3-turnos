...
// Ruta RELATIVA por defecto: en desarrollo la traduce el proxy de Vite (vite.config.ts) y en el
// contenedor la traduce nginx (nginx.conf). Así el bundle es portable y no hay CORS.
